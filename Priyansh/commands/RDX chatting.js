...
module.exports.config = {
    name: "rdx", // Changed from "misha" to "rdx"
    version: "1.0.9",
    hasPermssion: 0,
    credits: "Mirrykal)",
...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (userMessage.toLowerCase() === "on") {
        ...
        return api.sendMessage("Hyee baby! 😘 RDX auto-reply mode **ON** ho gaya... Ab sirf tumhare liye romantic ban gayi hu ❤️", threadID, messageID);
    }

    if (userMessage.toLowerCase() === "off") {
        autoReplyEnabled[senderID] = false;
        chatHistories[senderID] = [];
        return api.sendMessage("Hmm! 😒 RDX auto-reply mode **OFF** ho gaya... Tumne ignore kar diya na baby? 🥺", threadID, messageID);
    }
